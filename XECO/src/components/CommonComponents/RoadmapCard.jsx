const RoadmapCard = ({ title, desc, date }) => {
    return (
        <div className="relative px-4  max-w-[340px] ">


            {/* CARD */}
            <div className="relative bg-white/5 backdrop-blur-md rounded-2xl px-12 py-8 h-[320px] flex justify-center gap-4 flex-col  border border-white/10
