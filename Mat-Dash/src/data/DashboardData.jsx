...
export const CardData = [
    {
        ...
        title: "Total Orders",
        NumericValue: "16,689",
        icon: <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--solar text-white icon-27" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" data-icon="solar:dollar-minimalistic-linear" width="27" height="27"><g fill="none" stroke="#FFFFFF" stroke-width="1.5px"><circle cx="12" cy="12" r="10" stroke="#FFFFFF" fill="none" stroke-width="1.5px"></circle><path stroke-linecap="round" d="M12 17v1m0-12v1m3 2.5C15 8.12 13.657 7 12 7S9 8.12 9 9.5s1.343 2.5 3 2.5s3 1.12 3 2.5s-1.343 2.5-3 2.5s-3-1.12-3-2.5" stroke="#FFFFFF" fill="none" stroke-width="1.5px"></path></g></svg>,
        iconBgColor: "#635bff",
    ...
    },
    {
        ...
        title: "Return Item",
        NumericValue: "148",
        icon: <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--solar text-white icon-27" width="27" height="27" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" data-icon="solar:recive-twice-square-linear"><g fill="none" stroke="#FFFFFF" stroke-width="1.5px"></g>
            <path stroke-linecap="round" stroke-linejoin="round" d="M7 15.5h7m0 0L11 13m3 2.5L11 18M7 8.5h7m0 0L11 6m3 2.5L11 11" stroke="#FFFFFF" fill="none" stroke-width="1.5px"></path><path stroke-linecap="round" d="M17 6v12" stroke="#FFFFFF" fill="none" stroke-width="1.5px"></path><path d="M2 12c0-4.714 0-7.071 1.464-8.536C4.93 2 7.286 2 12 2s7.071 0 8.535 1.464C22 4.93 22 7.286 22 12s0 7.071-1.465 8.535C19.072 22 16.714 22 12 22s-7.071 0-8.536-1.465C2 19.072 2 16.714 2 12Z" stroke="#FFFFFF" fill="none" stroke-width="1.5px"></path></svg>,
        iconBgColor: "#F8C20A",
