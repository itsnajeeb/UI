...
import { AUTHENTICATION_PAGE_NAV_LINK } from "../../data/SideBarData";
...
export const AUTHENTICATION_PAGE = () => {
    ...
    return (
        <Box sx={{ bgcolor: 'white', height: '100%', width: '100%', padding: 0 }}>
            {AUTHENTICATION_PAGE_NAV_LINK.map((sectionData, index) => (
                <div key={index} className=" p-0">
                    ...
                    {index < AUTHENTICATION_PAGE_NAV_LINK.length - 1 && <Divider sx={{ my: 2, borderColor: '#EDF2F7' }} />}
                </div>
            ))}
        </Box>
    );
