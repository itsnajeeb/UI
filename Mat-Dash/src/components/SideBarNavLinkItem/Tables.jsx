...
import { PAGES_NAV_ITEM, TABLES_NAV_LINK } from "../../data/SideBarData";
...
export const TABLE = () => {
    ...
    return (
        <Box sx={{ bgcolor: 'white', height: '100%', width: '100%', padding: 0 }}>
            {TABLES_NAV_LINK.map((sectionData, index) => (
                <div key={index} className=" p-0">
                    ...
                    {index < TABLES_NAV_LINK.length - 1 && <Divider sx={{ my: 2, borderColor: '#EDF2F7' }} />}
                </div>
            ))}
        </Box>
    );
