...
const Card = ({ bgColor, icon, text, total }) => {
    const profit = false
    return (
        <div className={`relative px-7 py-8 flex  rounded-xl max-w-2xl w-[240px]  bg-white boxShadow text-black ` } >
            <div className='flex flex-col items-center justify-center space-y-1  mx-auto'>
                ...
                <h1 className='text-3xl font-bold text-[#635BFF]'>{"$" + total}</h1>
                <p></p>
