    ...
    return (
        <div className='bg-white  flex md:py-7 rounded-xl   manrope-fontFamliy py-5'>
            <div className='relative min-w-68 md:min-w-100 flex items-center justify-center md:px-10  px-4'>
                <input type="text" 
                    className='peer border-2 border-gray-200/80 text-[15px] rounded-lg py-2 px-4 w-full outline-none focus:border-indigo-600 transition-all duration-300 bg-transparent placeholder-transparent'
