...
const WeeklyStats = () => {
  return (
    <div className="bg-white rounded-xl shadow  p-6 w-full manrope-fontFamily h-full">
      {/* Header */}
      <div className="mb-6">
        <h2 className="text-lg text-[#29343d] font-semibold manrope-fontFamily">Weekly Stats</h2>
      ...
      <div className="flex justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="font-semibold text-gray-900">$36,850</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="font-semibold text-gray-900">$4,720</p>
          </div>
        </div>
      </div>
    </div>
