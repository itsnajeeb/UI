    ...
    return (
        <div className='bg-white px-7 py-6 shadow rounded-lg flex flex-col gap-5'>
            ...
            <div className='flex flex-col '>
                ...
                <div >
                    <div className='w-full bg-gray-400/30 h-1 rounded-full'>
                        <div className='w-[80%] bg-[#0fd5cf] h-full rounded-full'></div>
                    </div>
                </div>
            </div>
        </div>
