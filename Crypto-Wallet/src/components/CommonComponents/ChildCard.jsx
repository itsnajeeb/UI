...
const ChildCard = ({ data }) => {
    ...
    return (
        <div className='bg-secondary relative flex justify-between w-full px-4 rounded-xl py-3 border-2 border-gray-400/30 '>
            ...
            <div className='flex text-white flex-col'>
                <div className='w-9 h-9 mb-2 rounded text-black flex justify-center items-center' >
                       <img src={data.icon} alt="icon" className='w-full h-full overflow-visible object-cover object-center' />
                </div>
