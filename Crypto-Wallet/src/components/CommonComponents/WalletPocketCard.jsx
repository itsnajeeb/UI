...
export default function WalletPocketCard({totalWithdrawal}) {
    ...
    return (
        ...
        <div className="p-4 rounded-xl ">
            ...
            <div className="relative w-55  grid place-items-center">

                {/* BACK POCKET */}
                <div
                    className="
                        absolute -top-6 left-1/2 -translate-x-1/2
                        w-50 h-40 bg-gray-800 rounded-3xl z-0
                    "
                ></div>
                ...
                <div
                    className={`
                        ...
                        w-45 h-30 bg-gray-100 rounded-xl boxShadow
                ...
                <div
                    className="
                        absolute top-8 w-50 h-27.5 
                        bg-gray-800 rounded-3xl shadow-xl
