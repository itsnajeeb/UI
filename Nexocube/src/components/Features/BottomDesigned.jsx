  ...
  return (
    <div className='mt-20'>
      ...
      <div className=''>
        ...
        <div className='lg:w-125  mt-2 h-1 btnGradient mx-auto rounded-full'>

        </div>
      </div>

      <div className='roadmap-content px-10 md:px-10 lg:px-20 grid grid-cols-1 lg:grid-cols-[1fr_1.2fr_350px] gap-10 mt-10 md:mt-20  mx-auto'>

        <div>
          <h1 className='success-title font-bold text-2xl md:text-3xl mb-5'>Forex Market</h1>
        ...
        <div className='rounded-xl'>
          <img src={image1} alt="image" className='overflow-hidden lg:h-[65vh] rounded-xl h-full w-full' />
        </div>
        <div>
          <h1 className='success-title font-bold text-2xl md:text-3xl mb-5'>CRYPTO MARKET</h1>
          <ul className='flex flex-col gap-3 list-none'>
            <li className='flex-row  flex items-start gap-1'>
